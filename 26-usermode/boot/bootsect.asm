...
INITRD_OFFSET equ 0xA000 ;
    ...
    call load_initrd; // read initrd to from disk
...
load_kernel:
    ...
    mov bx, KERNEL_OFFSET ; Read from disk and store in 0xA000
...
load_initrd:  ;增加的加载代码
    ...
    mov bx, INITRD_OFFSET ; Read from disk and store in 0x1000
     mov cl, 0x01 ; cl <- sector (0x01 .. 0x11)
                 ; 0x01 is our boot sector, 0x02 is the first 'available' sector
    mov dh, 31 ; Our future kernel will be larger, make this big
    mov dl, 0x1 ; dl <- drive number. Our caller sets it as a parameter and gets it from BIOS
